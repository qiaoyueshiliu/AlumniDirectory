                        ...
                        <td colspan="6">
                            <div class="pg">
                                    ...
                                    $(function () {
                                        ...
                                        $("#searchPageBtn").click(function () {
                                            ...
                                            if (pageNo < 1 || pageNo > pageTotal) {
                                                ...
                                                location.href = "${pageScope.basePath}/manager/yonghuguanliServlet?action=page&pageNo=" + pageNo;
                                            }
                                        });
                                    });
                                </script>
                                <a class="nxt" href="manager/yonghuguanliServlet?action=page&pageNo=1">首页</a>
                                <c:if test="${requestScope.page.pageNo > 1}">
                                    <a class="nxt"
                                       href="manager/yonghuguanliServlet?action=page&pageNo=${requestScope.page.pageNo-1}">上一页</a>
                                </c:if>
                                <%--页码输出的开始--%>
                                <c:choose>
                                    <%--情况1：页码小于5页--%>
                                ...
                                <c:forEach begin="${begin}" end="${end}" var="i">
                                    ...
                                    <c:if test="${i != requestScope.page.pageNo}">
                                        <a href="manager/yonghuguanliServlet?action=page&pageNo=${i}">${i}</a>
                                    </c:if>
                                </c:forEach>
                                <label>
                                ...
                                <c:if test="${requestScope.page.pageNo < requestScope.page.pageTotal}">
                                    <a class="nxt"
                                       href="manager/yonghuguanliServlet?action=page&pageNo=${requestScope.page.pageNo+1}">下一页</a>
                                </c:if>
                                <a class="nxt"
                                   href="manager/yonghuguanliServlet?action=page&pageNo=${requestScope.page.pageTotal}">末页</a>
                            </div>
                        </td>
                    </tr>
                </table>
