...
<div class="row">
    ...
    <div class="column middle">
        ...
        <div class="card">
            <h1 style="text-align: center;font-size: 48px;">活动公告管理</h1>
        </div>
        <div class="card">
            <div id="mainguanli">
                <sql:setDataSource
                ...
                <table>
                    ...
                    <c:forEach var="row" items="${requestScope.page.items}">
                        ...
                        <form action="" method="get">
                            ...
                            <tr>
                                <td>${row.huodongId}</td>
                                <input type="hidden" value="${row.huodongId}" name="huodongId">
                                <td>${row.huodongCreatetime}</td>
                                <td>${row.nickname}</td>
                                <td>${row.huodongBiaoti}</td>
                                <td>${row.huodongNeirong}</td>

                                <td style="width: 150px;">
                                    <a class="deleteClass" href="manager/huodongServlet?action=delete&huodongId=${row.huodongId}&pageNo=${requestScope.page.pageNo}">删除</a>
