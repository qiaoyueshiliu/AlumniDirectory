        ...
        <div class="card">
            <form action="Xunren/xunrenTianjia.jsp" method="get">
                ...
                <table id="rapidregTable" width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d0f0f2">
                    ...
                    <tr>
                        <td valign="top" bgcolor="#FFFFFF">发布内容 </td>
                        <td valign="top" bgcolor="#FFFFFF">
                            <div>
                                    <textarea  name="xunrenqishiNeirong"
                    ...
                    <tr>
                        <td>
                            <input type="submit" name="RegisterBtn" value="发布寻人启事" id="RegisterBtn"/>
                        </td>
                    </tr>
                </table>
            </form>
