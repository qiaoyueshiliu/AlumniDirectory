...
<div class="row">
    ...
    <div class="column middle">
        ...
        <div class="card">
            <h1 style="text-align: center;font-size: 48px;">寻人启事管理</h1>
        </div>
        <div class="card">
            <div id="mainguanli">
                <sql:setDataSource
                ...
                <table>
                    ...
                    <c:forEach var="row" items="${requestScope.page.items}">
                        ...
                        <form action="" method="get">
                            ...
                            <tr>
                                <td>${row.xunrenqishiId}</td>
                                <input type="hidden" value="${row.xunrenqishiId}" name="xunrenqishiId">
                                <td>${row.xunrenqishiCreatetime}</td>
                                <td>${row.nickname}</td>
                                <td>${row.xunrenqishiBiaoti}</td>
                                <td>${row.xunrenqishiNeirong}</td>

                                <td style="width: 150px;">
                                    <a class="deleteClass" href="manager/xunrenqishiServlet?action=delete&xunrenqishiId=${row.xunrenqishiId}&pageNo=${requestScope.page.pageNo}">删除</a>
