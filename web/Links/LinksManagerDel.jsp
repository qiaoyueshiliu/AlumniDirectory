...
<head>
    ...
    <meta http-equiv="refresh"
          content="3;URL=LinksManager.jsp">
</head>
<body>
...
<div class="row">
    ...
    <div class="column middle">
        ...
        <div class="card">
            <% System.out.println("LinksManagerDel:进行删除学校友情链接操作:"+request.getParameter("schoolname"));%>
            <span style="font-size:18px;">3s后自动跳转</span>
            <c:set var="zhuangtai1" value="删除"/>
            <%--传过来2为不通过--%>
            <c:if test="${param.pass eq zhuangtai1}">
                <sql:setDataSource
                        var="snapshot"
