        ...
        <div class="card">
            <form action="Fankui/fankuiTiaozhuan.jsp" method="get">
                ...
                <table id="rapidregTable" width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d0f0f2">
                    ...
                    <tr>
                        <td valign="top" bgcolor="#FFFFFF">反馈人 </td>
                        <td valign="top" bgcolor="#FFFFFF">
                            <input name="nickname"
                                   type="hidden" maxlength="20" size="15"
                    ...
                    <tr>
                        <td>
                            <input type="submit" name="RegisterBtn" value="发表反馈" id="RegisterBtn"/>
                        </td>
                    </tr>
                </table>
            </form>
