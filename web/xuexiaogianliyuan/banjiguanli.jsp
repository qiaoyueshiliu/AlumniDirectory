                ...
                <table>
                    ...
                    <c:forEach items="${requestScope.page.items}" var="user">
                        <tr>
                            ...
                            <td><a href="manager/banjiSerlvet?action=getUser&id=${user.id}&pageNo=${requestScope.page.pageNo}&xuexiao=${sessionScope.user.xuexiao}&banji=${sessionScope.user.banji}">修改</a>
